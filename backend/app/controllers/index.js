...
async function handle_advance(data) {
  ...
  // NOTE: replace the address in user above with your own address.
    ...
    //{"method": "create_project", "selectedCharacters": [2, 1, 3]}
    ...
    //{"method":"fight", "duelId": 1}
      ...
      // return an updated array of all players
      let allUsers = user.allUsers;
      const result3 = JSON.stringify({"method": "all_Players", "txId": totalTransactions, "target": data.metadata.msg_sender, "data": allUsers });
